...
type EsClientOption func(*EsClientOptions)

func WithEsAddresses(addresses []string) EsClientOption {
	return func(eco *EsClientOptions) {
		eco.addresses = addresses
	}
}
...
func WithLogger(logger logger.Logger) EsClientOption {
	return func(eco *EsClientOptions) {
		eco.logger = logger
	}
}
...
// func (c *elasticSearchClient) log(ctx context.Context, level logger.Level, message string, args ...interface{}) {
// 	if !c.logEnabled() {
// 		return
// 	}
...
// func (c *elasticSearchClient) logEnabled() bool {
// 	return c.options.logger != nil
// }
