...
func BeginSaga(sagaName string, params any) SagaCommand {
	return SagaCommand{
		ID:         uuid.NewString(),
...
func EndSaga(sagaName, sagaID string) SagaCommand {
	return SagaCommand{
		ID:        uuid.NewString(),
		SagaName:  sagaName,
		Name:      EndSagaCommand,
...
func AbortSaga(sagaName, sagaID string, transactionID string) SagaCommand {
	return SagaCommand{
		ID:            uuid.NewString(),
...
func BeginTransaction(sagaName, sagaID string, transactionID string, params any) SagaCommand {
	return SagaCommand{
		ID:            uuid.NewString(),
...
func EndTransaction(sagaName, sagaID, transactionID string, params any) SagaCommand {
	return SagaCommand{
		ID:            uuid.NewString(),
...
func EndTransactionCompensate(sagaName, sagaID string, transactionID, compensationID string, params any) SagaCommand {
	return SagaCommand{
		ID:             uuid.NewString(),
		Name:           EndTransactionCommand,
		SagaID:         sagaID,
...
func AbortTransaction(sagaName, sagaID string, transactionID string, params any) SagaCommand {
	return SagaCommand{
		ID:            uuid.NewString(),
